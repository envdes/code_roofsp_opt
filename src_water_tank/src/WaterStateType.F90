...
!JJ water tank
     real(r8), pointer :: water_tank_col         (:)   ! roof water tank (mm H2O)
!JJ
...
!JJ water tank
   allocate(this%water_tank_col          (begc:endc))                     ; this%water_tank_col         (:)   = nan
!JJ
...
!JJ water tank
    this%water_tank_col(begc:endc) = spval
    call hist_addfld1d (fname='WATER_TANK',  units='mm',  &
         avgflag='A', long_name='water tank', &
         ptr_col=this%water_tank_col)
!JJ
...
!JJ water tank
    call restartvar(ncid=ncid, flag=flag, varname='WATER_TANK', xtype=ncd_double,  &
         dim1name='column', &
         long_name='water tank', units='mm', &
         interpinic_flag='interp', readvar=readvar, data=this%water_tank_col)
