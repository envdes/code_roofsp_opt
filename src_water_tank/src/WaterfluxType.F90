...
!JJ water tank fluxes
     real(r8), pointer :: qflx_water_tank_in_col   (:)   ! col water tank fluxes (mm H2O/s)
     real(r8), pointer :: qflx_water_tank_out_col  (:)   ! col water tank fluxes (mm H2O/s)
!JJ
...
!JJ water tank fluxes
    allocate(this%qflx_water_tank_in_col   (begc:endc))              ; this%qflx_water_tank_in_col   (:)   = nan
    allocate(this%qflx_water_tank_out_col  (begc:endc))              ; this%qflx_water_tank_out_col  (:)   = nan
!JJ
...
!JJ water tank fluxes
     this%qflx_water_tank_in_col(begc:endc) = spval
     call hist_addfld1d (fname='QIN_WATER_TANK',  units='mm/s',  &
         avgflag='A', long_name='water input to water tank', &
         ptr_col=this%qflx_water_tank_in_col, c2l_scale_type='urbanf')

     this%qflx_water_tank_out_col(begc:endc) = spval
     call hist_addfld1d (fname='QOUT_WATER_TANK',  units='mm/s',  &
         avgflag='A', long_name='water output from water tank', &
         ptr_col=this%qflx_water_tank_out_col, c2l_scale_type='urbanf')
!JJ
...
!JJ water tank fluxes
    this%qflx_water_tank_in_col(bounds%begc:bounds%endc) = 0._r8
    this%qflx_water_tank_out_col(bounds%begc:bounds%endc) = 0._r8    
!JJ
