...
if [ $length -eq 1 ]; then
    echo "hist_fincl1='QOUT_WATER_TANK', 'QIN_WATER_TANK', 'WATER_TANK', 'URBAN_HEAT', 'WASTEHEAT', 'URBAN_AC', 'QOVER', 'TSA', 'HIA', 'HUMIDEX', 'TBUILD', 'RH2M','TG','TSKIN', 'Q2M','SWup','LWup','Rnet','Qh','Qle','Qstor','Rainf','TBUILD'" >> user_nl_clm_jj

elif [ $length -eq 2 ]; then
    echo "hist_fincl1='QOUT_WATER_TANK', 'QIN_WATER_TANK', 'WATER_TANK', 'URBAN_HEAT', 'WASTEHEAT', 'URBAN_AC', 'QOVER', 'TSA', 'HIA', 'HUMIDEX', 'TBUILD', 'RH2M','TG','TSKIN', 'Q2M','SWup','LWup','Rnet','Qh','Qle','Qstor','Rainf','TBUILD'" >> user_nl_clm_jj
    echo "hist_fincl2='QOUT_WATER_TANK', 'QIN_WATER_TANK', 'WATER_TANK', 'URBAN_HEAT', 'WASTEHEAT', 'URBAN_AC', 'QOVER', 'TSA', 'HIA', 'HUMIDEX', 'TBUILD', 'RH2M','TG','TSKIN', 'Q2M','SWup','LWup','Rnet','Qh','Qle','Qstor','Rainf','TBUILD'" >> user_nl_clm_jj

else
    echo "hist_fincl1='QOUT_WATER_TANK', 'QIN_WATER_TANK', 'WATER_TANK', 'URBAN_HEAT', 'WASTEHEAT', 'URBAN_AC', 'QOVER', 'TSA', 'HIA', 'HUMIDEX', 'TBUILD', 'RH2M','TG','TSKIN', 'Q2M','SWup','LWup','Rnet','Qh','Qle','Qstor','Rainf','TBUILD'" >> user_nl_clm_jj
    echo "hist_fincl2='QOUT_WATER_TANK', 'QIN_WATER_TANK', 'WATER_TANK', 'URBAN_HEAT', 'WASTEHEAT', 'URBAN_AC', 'QOVER', 'TSA', 'HIA', 'HUMIDEX', 'TBUILD', 'RH2M','TG','TSKIN', 'Q2M','SWup','LWup','Rnet','Qh','Qle','Qstor','Rainf','TBUILD'" >> user_nl_clm_jj
    echo "hist_fincl3='QOUT_WATER_TANK', 'QIN_WATER_TANK', 'WATER_TANK', 'URBAN_HEAT', 'WASTEHEAT', 'URBAN_AC', 'QOVER', 'TSA', 'HIA', 'HUMIDEX', 'TBUILD', 'RH2M','TG','TSKIN', 'Q2M','SWup','LWup','Rnet','Qh','Qle','Qstor','Rainf','TBUILD'" >> user_nl_clm_jj
fi
